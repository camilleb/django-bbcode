...
class Youtube(TagNode):
    ...
    def parse(self):
        ...
        videoid = videoid[0]
        return (
            '<iframe width="100%%" height="250" src="http://www.youtube.com/embed/%s" frameborder="0" allowfullscreen></iframe>' % videoid
        )
...
class Dailymotion(TagNode):
    ...
    def parse(self):
        ...
        videoid = videoid[0]
        return (
            '<iframe frameborder="0" width="100%%" height="250" src="http://www.dailymotion.com/embed/video/%s"></iframe>' % videoid
        )
